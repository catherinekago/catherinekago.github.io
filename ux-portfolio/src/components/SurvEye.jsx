...
const SurvEye = () => {
  ...
  const listIemsRequirements = [
    {
      icon: magnifierIcon,
      title: "Allow for initial inspection",
      text: "In gaze-based interaction, the eyes are used  for both inspecting and selecting elements, which can result in unintentional selection. Thus, enable the user to inspect their options prior to selecting.",
    },
    {
      icon: deblurIcon,
      title: "Consider varying accuracy of eye-tracking technology",
    ...
    {
      icon: invisibleIcon,
      title: "Provide robustness against blinking",
  ...
  const cardGroupItemsOutcome = [
    {
      ...
      text: (
        <p class="title-medium">
          ...
          <span style={{ fontWeight: "700" }}>inspection area</span>
        </p>
      ),
    },
    {
      ...
      text: (
        <p class="title-medium">
          Minimize required <span style={{ fontWeight: "700" }}>saccades</span>
        </p>
      ),
    },
    {
      ...
      text: (
        <p class="title-medium">
          Acknowledge time for{" "}
          <span style={{ fontWeight: "700" }}>inspection</span>
        </p>
      ),
    },
    {
      ...
      text: (
        <p class="title-medium">
          Avoid prolonged{" "}
          <span style={{ fontWeight: "700" }}>gaze fixations</span>
        </p>
      ),
    },
    {
      ...
      text: (
        <p class="title-medium">
          Exploit{" "}
          <span style={{ fontWeight: "700" }}>object-based attention</span>
        </p>
      ),
    },
    {
      ...
      text: (
        <p class="title-medium">
          Provide <span style={{ fontWeight: "700" }}>visual anchors</span>
        </p>
      ),
    },
    {
      ...
      text: (
        <p class="title-medium">
          Avoid unnecessary <span style={{ fontWeight: "700" }}>movement</span>
        </p>
      ),
    },
    {
      ...
      text: (
        <p class="title-medium">
          ...
          <span style={{ fontWeight: "700" }}>visual spacings</span>
        </p>
      ),
    },
  ];
    ...
    <div class="main-content card-group">
      <div class="card-container container-gray">
        ...
        <div class="card-content-container">
          <p class="title-medium" style={{ color: "#6F8463" }}>
            {" "}
            <span style={{ fontWeight: "700" }}>independent</span>
          </p>
          <p
            style={{
              color: "#9A9A9A",
            ...
            class="title-medium"
          >
            <span style={{ fontWeight: "700" }}>anonymous</span>
          </p>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <ProjectSection
        ...
        headline={heroTitle}
        text={
          <p class="title-medium main-content">
            <span style={{ fontWeight: "700" }}>
              A genuine project of the heart
            </span>
            , which happened to coincide my bachelor thesis for my studies in
            Human-Computer-Interaction. <br /> <br /> Exploring{" "}
            <span style={{ fontWeight: "700" }}>
              gaze-based questionnaire design
            </span>{" "}
            to make questionnaires accessible to individuals with manual
            impairment.
          </p>
        }
        image={SurvEyeHero}
        imageAlt={
          "A mockup of the surveye interface: it shows a likert item with the statement 'Snape was a good guy' and options ranging from 'strongly disagree' to 'strongly agree' to select."
        }
        secondImage={null}
        width={size.width}
      />
      ...
      <ProjectSection
        ...
        text={
          <p class="title-medium main-content">
            ...
            questionnaires{" "}
            <span style={{ fontWeight: "700" }}>into a task flow</span>:
          </p>
        }
      ...
      <ProjectContent
        ...
        content1={
          <p class="title-medium main-content">
            ...
            <span style={{ fontWeight: "700" }}>goal</span> of my solution:
          </p>
        }
        content2={
          <h2 class=" title-extralarge main-content">
            Enable manually impaired individuals to{" "}
            <span style={{ fontFamily: "Abril Fatface", fontSize: "40px" }}>
              independently
            </span>{" "}
            and{" "}
            <span style={{ fontFamily: "Abril Fatface", fontSize: "40px" }}>
      ...
      <ProjectContent
        ...
        content1={
          <p class="title-medium main-content">
            I summarized the outcome of my investigation in{" "}
            <span style={{ fontWeight: "700" }}>four key requirements</span>:
          </p>
        }
      ...
      <ProjectSection
        ...
        text={
          <p class="title-medium main-content">
            With the requirements in mind, I explored different gaze-based
            interface designs for likert items covering either a discrete or a
            continuous scale. Together with my supervisor I evaluated the
            designs and selected the{" "}
            <span style={{ fontWeight: "700" }}>
        ...
        imageAlt={
          "An illustration of an astronaut standing on a spaceship, surving past planets."
        }
        secondImage={null}
        width={size.width}
      />
      ...
      <ProjectContent
        ...
        content1={
          <p class="title-medium main-content">
            ...
            <span style={{ fontWeight: "700" }}>states and transitions</span>,
            as well as how to best provide{" "}
            <span style={{ fontWeight: "700" }}>visual feedback</span> to the
            user. The{" "}
            <span style={{ fontWeight: "700" }}>interaction flow</span> below
      ...
      <ProjectSection
        ...
        text={
          <p class="title-medium main-content">
            ...
            in the background to collect quantitative data during my user
            testings. To capture gaze input in real-time I used the eye-tracking
            library{" "}
            <a class="inline-link" href="https://webgazer.cs.brown.edu/">
      ...
      <ProjectContent
        ...
        content3={
          <div class="content-horizontal">
            {" "}
            <img class="img-two-columns" src={mockup_l1} alt={""} />{" "}
            <img class="img-two-columns" src={mockup_l2} alt={""} />
          </div>
        }
      />
      ...
      <ProjectContent
        ...
        content3={
          <div class="content-horizontal">
            {" "}
            <img class="img-two-columns" src={mockup_s1} alt={""} />{" "}
            <img class="img-two-columns" src={mockup_s2} alt={""} />
          </div>
        }
      />
      ...
      <ProjectSection
        ...
        text={
          <p class="title-medium main-content">
            ...
            to <span style={{ fontWeight: "700" }}>think aloud</span> during the
            interaction so I could get deeper insights on their perceptions and
            thoughts. Additionally, I evaluated{" "}
            <span style={{ fontWeight: "700" }}>usability</span> with the{" "}
            <a
              class="inline-link"
              href="https://www.usability.gov/how-to-and-tools/methods/system-usability-scale.html"
            >
              <span style={{ fontWeight: "700" }}>SUS</span>
            </a>{" "}
            and <span style={{ fontWeight: "700" }}>workload</span> with the{" "}
            <a
              class="inline-link"
              href="https://humansystems.arc.nasa.gov/groups/TLX/"
            >
              <span style={{ fontWeight: "700" }}>NASA-TLX</span>
            </a>{" "}
      ...
      <ProjectContent
        ...
        content2={
          <p class="title-medium main-content">
            ...
            <span style={{ fontWeight: "700" }}>
              eight recommendations for the design of gaze-based interfaces
            </span>{" "}
            for manually impaired individuals:
          </p>
        }
