...
const DesignSystem = () => {
  ...
  text={<p class="text-l text-dark">I identified the following <span class="text-l text-title">pain points</span>:</p>}
  content={<ItemGroup type="box" size="large"
    ...
    text={<p class="text-l text-dark">I explored <span class="text-l text-title">four possible approaches to structure our own design system</span>:</p>}
